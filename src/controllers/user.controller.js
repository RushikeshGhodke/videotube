...
const updateAvatarImage = asyncHandler(async(req, res) => {
    ...
    return res.status(200).json(new ApiRespone(200, user, "Avatar image updated successfully"))
})

export { registerUser, loginUser, logoutUser, refreshAccessToken, changeCurrentPassword, updateAvatarImage };
